(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactContextHook = {}, global.React, global.Redux));
  ...
  var StoreContext = /*#__PURE__*/React__default['default'].createContext(null);
  ...
  function storeCreator() {
    ...
    return redux.createStore(rootReducer, {
      main: initialValue
    }, redux.applyMiddleware.apply(void 0, _toConsumableArray(middlewares)));
  }
  ...
  exports.store = createRawStore(storeCreator());
  /**
  ...
  var withStore = function withStore(WrappedComponent, initialValue, config) {
    ...
    exports.store = createRawStore(store);
  ...
  function useSelector(stateSelectorFn) {
    ...
    var latestStateSelectorFn = React.useRef();
  ...
  function useDeleteStoreValue(key) {
    var _useContext3 = React.useContext(StoreContext),
  ...
  exports.useDeleteStoreValue = useDeleteStoreValue;
  exports.useGetAndDelete = useGetAndDelete;
  exports.useGetAndSet = useGetAndSet;
  exports.useSetAndDelete = useSetAndDelete;
  exports.useSetStoreValue = useSetStoreValue;
...
//# sourceMappingURL=react-context-hook.js.map
